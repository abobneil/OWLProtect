...
Node.js is available in this environment and powers the admin portal workspace.
The `.NET` SDK is not installed on this machine, so the C# projects are scaffolded
but not compiled in this session.
